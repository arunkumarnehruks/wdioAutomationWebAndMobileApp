...
const STR_LIMIT = 80;
const KEY_LIMIT = 12;
export async function toBeRequestedWith(received, requestedWith = {}, options = {}) {
    ...
    const message = enhanceError('mock', minifyRequestedWith(requestedWith), minifyRequestMock(actual, requestedWith) || 'was not called', this, verb, expectation, '', options);
    return {
        pass,
        message: () => message,
    };
